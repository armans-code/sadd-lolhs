...
import people from '../images/home/people_mask.png';
import rrb_trim from '../images/home/rrb_trim.png';
import hold_poster from '../images/home/hold_poster.png';
                    ...
                    >
                        <div class="flex flex-col w-full md:w-2/5 justify-center items-center md:items-start text-center md:text-left">
                            ...
                            <p class="leading-normal text-2xl mb-8">
                                ...
                                &nbsp;Club aims to foster a safe space for
                                education on stigmatized issues to help students
                        ...
                        <div class="w-full md:w-3/5 py-6 text-center hidden md:block">
                            <img
                                class="w-full ml-10 rounded-3xl z-50"
                                src={people}
                                alt=""
                            />
                        </div>
                        ...
                        <div data-aos="fade-up" class="flex flex-wrap">
                            <div class="w-5/6 sm:w-1/2 p-6">
                                ...
                                <p class="text-gray-600 mb-8">
                                    ...
                                    a national non-profit dedicated to the
                                    safety and wellness of all students. Using
                                    40 years of expertise to facilitate
                                    educational and engaging programming, SADD
                                    operates through school and community
                                    chapters (like student clubs) dedicated to
                                    advocating healthy decision-making.
                                    <br />
                                    <br />
                        ...
                        >
                            ...
                            <div class="w-full sm:w-1/2 p-6 mt-6">
                                <div class="align-middle">
                                    ...
                                    <p class="text-gray-600 mb-8">
                                        In order to join the chapter as a
                                        member, you must attend Land O' Lakes
